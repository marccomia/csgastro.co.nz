	...
	<div class="row">
			<ul class="portfolio-list sort-destination" data-sort-id="portfolio">				
				<% loop $PatientInfoDetails %>
					<% loop $Categories %>
						<li class="col-md-4 col-sm-6 col-xs-12 isotope-item {$Title}">
							<div class="portfolio-item img-thumbnail">
								<a href="$Up.Link" class="thumb-info">
									...
									<span class="thumb-info-title">
										<span class="thumb-info-inner" data-toggle="tooltip" data-placement="top" title="{$Up.Title}">$Up.Title.LimitCharacters(12,'...')</span>
