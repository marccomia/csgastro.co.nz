...
class PatientInfoDetailsPage extends Page {
    ...
    public function getCMSFields() 
    {
        ...
        $fields->addFieldToTab('Root.Main', $photo = UploadField::create('Photo')->setDescription("This is for the main Photo of this Page"), 'Content');
        $fields->addFieldToTab('Root.Main', TextField::create('Authortxt','Author')->setDescription("Example Dr. Cameron Schauer"), 'Content');   
